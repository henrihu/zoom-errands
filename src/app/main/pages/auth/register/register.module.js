(function ()
{
    ...
    handlerEmailConfirmation.$inject = ['$state', '$rootScope'];
    function handlerEmailConfirmation($state, $rootScope)
    {
        ...
        $rootScope.$on('auth:email-confirmation-error', function(ev, user) {
