(function ()
{
    ...
    /** @ngInject */
    EditerrandProviderController.$inject = [ '$scope', 'Restangular', '$stateParams', 'toastr'];
    function EditerrandProviderController($scope, Restangular, $stateParams, toastr)
    {
        var vm = this; 
        ...
        Restangular.all('provider/alltypes').getList()
        .then(function(types) {
            // console.log(types);
            vm.alltypes = types;
        });
